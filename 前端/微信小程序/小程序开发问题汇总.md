...
| bindrefresherrefresh    | 下拉到触发阈值的handle函数 `='pullFunction'`            |
...
<view class="award-image-view">
	...
	<view style="margin-top: -470rpx; z-index:99;" >
		<image src="/images/award-border.png" style="width: 686rpx;"></image>  
	</view>
	<view style="margin-top: -470rpx; z-index: 999;">
...
- [ ] 3.后台增加组织架构表，里面包括公司和部门数据（吴晨和孙秋成，已完成🐮）
...
- [ ] 14.冠军档案小程序上线（梁泽胜，已完成微信中可以搜索，目前正在迭代）
